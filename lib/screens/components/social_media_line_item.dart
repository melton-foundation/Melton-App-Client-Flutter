                ...
                children: [
                  ...
                  instagram == null
                      ...
                      : IconButton(
                          ...
                          onPressed: () {
                            launchSocialMediaUrl(instagram);
                          },
                          iconSize: 36.0,
                      ...
                      : IconButton(
                          ...
                          onPressed: () {
                            showDialog(
                                ...
                                builder: (context) {
                                  return AlertDialog(
                                    title: Text("WeChat/Weixin ID"),
                                    content: SelectableText(wechat),
                                  );
                                });
                          },
                          iconSize: 36.0,
        ...
        builder: (context) {
          return AlertDialog(
            title: Text(
              "MORE LINKS",
              style: TextStyle(
                  color: Constants.meltonBlue, fontWeight: FontWeight.bold),
            ),
            content: Container(
              height: 175.0,
              width: 100.0,
